...
import DashboardHome from './receptionist/DashboardHome';
import PatientsPage from './receptionist/PatientsPage';
import AppointmentsPage from './receptionist/AppointmentsPage';
import CalendarPage from './receptionist/CalendarPage';
import RegisterPatientPage from './receptionist/RegisterPatientPage';
import SearchPatientsPage from './receptionist/SearchPatientsPage';
...
const ReceptionistDashboard = ({ user, onLogout }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <ReceptionistSidebar user={user} stats={stats} unreadNotifications={stats.unreadNotifications} />
      ...
      <div className="lg:ml-64 p-4 sm:p-6 md:p-8 pt-20 lg:pt-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 sm:mb-8">
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-gray-800">Receptionist Dashboard</h1>
        ...
        <Routes>
          ...
          <Route path="/register" element={<RegisterPatientPage user={user} />} />
          <Route path="/search" element={<SearchPatientsPage user={user} />} />
        </Routes>
      </div>
    </div>
  );
